...
async function directorLogin() {
    ...
    try {
        const response = await fetch('https://floppokerbot.onrender.com/api/auth/login', {
            method: 'POST',
...
async function playerLogin() {
    ...
    try {
        const response = await fetch('https://floppokerbot.onrender.com/api/auth/telegram', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function loadUserProfile() {
    ...
    try {
        const response = await fetch(`https://floppokerbot.onrender.com/api/user/profile/${currentUser.id}`);
        const result = await response.json();
...
async function loadTournaments() {
    try {
        ...
        const response = await fetch('https://floppokerbot.onrender.com/api/tournaments');
...
async function loadTournamentsWithStatus(status) {
    try {
        const response = await fetch(`https://floppokerbot.onrender.com/api/tournaments?status=${status}`);
        const tournaments = await response.json();
        displayTournaments(tournaments);
    } catch (error) {
        document.getElementById('tournaments-list').innerHTML = '<div class="empty-state">Ошибка загрузки турниров</div>';
...
async function showTournamentDetail(tournamentId) {
    try {
        const response = await fetch(`https://floppokerbot.onrender.com/api/tournaments/${tournamentId}`);
...
async function updatePlayerChips(tournamentId, playerUserId, chips) {
    ...
    try {
        const response = await fetch(`https://floppokerbot.onrender.com/api/tournaments/${tournamentId}/update-chips`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
...
async function registerForCurrentTournament() {
    ...
    try {
        const response = await fetch('https://floppokerbot.onrender.com/api/register', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                user_id: currentUser.id,
...
async function startTournament(tournamentId) {
    ...
    try {
        const response = await fetch(`https://floppokerbot.onrender.com/api/tournaments/${tournamentId}/start`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function closeLateRegistration(tournamentId) {
    ...
    try {
        const response = await fetch(`https://floppokerbot.onrender.com/api/tournaments/${tournamentId}/close-late-reg`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ user_id: currentUser.id })
        });
...
async function completeTournament(tournamentId) {
    ...
    try {
        const response = await fetch(`https://floppokerbot.onrender.com/api/tournaments/${tournamentId}/complete`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ user_id: currentUser.id })
        });
...
async function createTournamentTables(tournamentId) {
    ...
    try {
        const response = await fetch(`https://floppokerbot.onrender.com/api/tournaments/${tournamentId}/create-tables`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ user_id: currentUser.id })
        });
...
async function showTournamentTables(tournamentId) {
    try {
        const response = await fetch(`https://floppokerbot.onrender.com/api/tournaments/${tournamentId}/tables`);
        const result = await response.json();
...
async function saveTournament() {
    ...
    try {
        const url = editingTournamentId 
            ? `https://floppokerbot.onrender.com/api/tournaments/${editingTournamentId}`
            : 'https://floppokerbot.onrender.com/api/tournaments';
...
async function loadRating() {
    try {
        ...
        const response = await fetch('https://floppokerbot.onrender.com/api/rating');
...
async function deleteRating(ratingId) {
    ...
    try {
        const response = await fetch(`https://floppokerbot.onrender.com/api/rating/${ratingId}`, {
            method: 'DELETE',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ user_id: currentUser.id })
        });
...
async function saveRating() {
    ...
    try {
        const url = editingRatingId 
            ? `https://floppokerbot.onrender.com/api/rating/${editingRatingId}`
            : 'https://floppokerbot.onrender.com/api/rating';
...
async function loadPlayers() {
    try {
        const response = await fetch(`https://floppokerbot.onrender.com/api/admin/players?user_id=${currentUser.id}`);
...
async function deletePlayer(playerId) {
    ...
    try {
        const response = await fetch(`https://floppokerbot.onrender.com/api/admin/players/${playerId}`, {
            method: 'DELETE',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ user_id: currentUser.id })
        });
...
async function savePlayer() {
    ...
    try {
        const response = await fetch('https://floppokerbot.onrender.com/api/admin/create_player', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
